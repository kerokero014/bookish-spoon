  ...
  describe('Post Controller', () => {
    describe('getPosts', () => {
        ...
        const mockPosts = [
          {
            ...
            content: 'This is the main content of my blog post. It can include text and even some <b>formatting</b>!',
      ...
      it('should handle errors', async () => {
        ...
        expect(res.json).toHaveBeenCalledWith({ message: 'Error getting posts', error: errorMessage });
      });
    });
    ...
    describe('updatePost', () => {
      ...
      it('should handle errors', async () => {
        ...
        expect(res.status).toHaveBeenCalledWith(500);
        expect(res.json).toHaveBeenCalledWith({ message: 'Error updating post', error: errorMessage });
      });
    });
